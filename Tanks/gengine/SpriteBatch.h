...
namespace gengine {
	...
	public:
		...
		Glyph(const glm::vec4& destRect, const glm::vec4& uvRect, GLuint Texture, float Depth, const ColorRGBA8& color, float angle, glm::vec4& aboutCenter);
	...
	public:
		...
		void draw(const glm::vec4& destRect, const glm::vec4& uvRect, GLuint texture, float depth, const ColorRGBA8& color, float angle, glm::vec4& aboutCenter);
		// Adds a glyph to the spritebatch with rotation
